...
def setup_driver():
    ...
    try:
        from selenium import webdriver
        from selenium.common.exceptions import StaleElementReferenceException
        from selenium.webdriver.edge.options import Options  # 导入Edge的Options类
    except Exception as e:
        print(e)
        print("Please install Selenium and Microsoft Edge webdriver for manual checking of captchas")

    # print('Loading...')
    edge_options = Options()
    edge_options.add_argument("disable-infobars")
    driver = webdriver.Edge(options=edge_options)  # 使用Edge WebDriver
    return driver
