...
- ..."""
    ...
    dialogAgent_Qwen = DialogAgent(name="Reviewer 1", model_config_name="qwen-max-0919", sys_prompt=role) #"qwen-max-0919"
...
if __name__ == "__main__":
    ...
    moa_table(model_configs=model_configs,topic='',draft='')
